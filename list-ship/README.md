...
Same as Product is [Not in Seller's Catalog](./#product-not-in-sellers-catalog).
...
8\) After verifying your related information on [**Review Page**](./#review-items-page) ****click on `Create Shipments` button to Ship Product according to Quantity.
